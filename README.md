...
It is possible to explain the above in a way that is actually comprehensible, but to really appreciate it takes years of study or prior knowledge of various subjects. I've studied math and physics as a hobby for so long that being able to comprehend the interplay of complex numbers, linear algebra, wave mechanics, and how those can be used to implement quantum logic gates is one of the most beautiful intellectual experiences I've had so far.
